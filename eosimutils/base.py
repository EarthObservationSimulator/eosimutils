...
class ReferenceFrame:
    ...
    def get(cls, name: str):
        ...
        Args:
            name (str or ReferenceFrame): The name of the reference frame to retrieve, or a
                ReferenceFrame instance.

        Returns:
            ReferenceFrame or None: The reference frame if found, the instance if already
                a ReferenceFrame, or None if not found.
        """
