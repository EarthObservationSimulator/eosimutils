...
class TestTimeseries(unittest.TestCase):
        ...
        self.time = AbsoluteDateArray.from_dict(
            {
                ...
                "times": [JD_OF_J2000 + t for t in [0, 1, 2, 3]],
                "time_scale": "UTC",
            }
        )
    ...
    def test_resample_data(self):
        ...
        new_time = AbsoluteDateArray.from_dict(
            {
                "time_format": "Julian_Date",
                "times": [JD_OF_J2000 + t for t in [0.5, 1.5, 2.5, 4.5]],
                "time_scale": "UTC",
            }
        )
        ...
        np.testing.assert_allclose(resampled_time.et, new_time.et)
    ...
    def test_remove_gaps_data(self):
        ...
        np.testing.assert_allclose(
            trimmed_time.to_dict("JULIAN_DATE")["times"],
    ...
    def test_to_dict_and_from_dict(self):
        ...
        np.testing.assert_allclose(
            deserialized.time.et, self.timeseries.time.et, rtol=1e-4, atol=1e-4
        )
    ...
    def test_edge_case_empty_data(self):
        ...
        empty_time = AbsoluteDateArray.from_dict(
            {"time_format": "Julian_Date", "times": [], "time_scale": "UTC"}
        )
        empty_data = []
        ts = Timeseries.from_dict(
            {
    ...
    def test_edge_case_single_point_interpolation(self):
        ...
        new_time = AbsoluteDateArray.from_dict(
            {
                "time_format": "Julian_Date",
                "times": [JD_OF_J2000 + t for t in [0.5, 1.5, 2.5]],
                "time_scale": "UTC",
            }
        )
        resampled_time, resampled_data, _ = ts._resample_data(new_time.et)
